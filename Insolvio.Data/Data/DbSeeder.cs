...
public static class DbSeeder
{
  public static async Task SeedAsync(ApplicationDbContext db)
  {
    ...
    db.InsolvencyFirms.Add(new InsolvencyFirm
    {
      Id = firmId,
      TenantId = tenantId,
      FirmName = "Cabinet Insolvio IPURL",
      CuiRo = "RO99887766",
      ...
      Email = "office@insolvio.local",
      Website = "https://insolvio.local",
...
new SystemConfig { Id = Guid.NewGuid(), Key = "Deadlines:ReminderDays", Value = "7,3,1,0", Description = "Days before deadline to send reminders (comma-separated)", Group = "Deadlines", CreatedOn = DateTime.UtcNow, CreatedBy = "System" }
    ...
    db.TenantDeadlineSettings.Add(new TenantDeadlineSettings
    {
      ...
      EmailFromName = "Insolvio Notifications",
      CreatedOn = DateTime.UtcNow,
      CreatedBy = "System"
    });
  ...
  public static async Task EnsureDemoUsersAsync(ApplicationDbContext db)
  {
    ...
    var demoUsers = new[]
    {
      new { Email = "admin@insolvio.local",          Password = "Admin123!",   First = "Admin",  Last = "User",  Role = UserRole.GlobalAdmin  },
      new { Email = "tenantadmin@insolvio.local",    Password = "TAdmin123!",  First = "Tenant", Last = "Admin", Role = UserRole.TenantAdmin  },
      new { Email = "practitioner@insolvio.local",   Password = "Pract123!",   First = "Jon",    Last = "Doe",   Role = UserRole.Practitioner },
      new { Email = "secretary@insolvio.local",      Password = "Secr123!",    First = "Gipsz",  Last = "Jakab", Role = UserRole.Secretary    },
    };
