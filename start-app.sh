...
# -----------------------------------------------
info "[1/4] Starting SQL Server container..."
cd "$SCRIPT_DIR"
...
# -----------------------------------------------
info "[2/4] Waiting for SQL Server to accept connections..."
...
# -----------------------------------------------
# 4. Launch backend and frontend in new terminals
# -----------------------------------------------
info "[4/4] Starting backend and frontend..."
echo ""
echo -e "${BOLD} ============================================${NC}"
echo ""
