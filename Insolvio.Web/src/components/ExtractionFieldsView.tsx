...
export interface ExtractionFieldsViewProps {
  extractionResult: InsolvencyExtractionResult;
  currentUserName: string;
  onExtractionChange?: (updated: InsolvencyExtractionResult) => void;
  /** Show raw JSON block at the bottom (e.g. false in case detail to avoid duplication) */
  showRawJson?: boolean;
}
...
export default function ExtractionFieldsView({
  ...
  useEffect(() => {
    setDraft(JSON.parse(JSON.stringify(extractionResult)));
  }, [extractionResult]);
