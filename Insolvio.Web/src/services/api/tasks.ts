...
export const tasksApi = {
  ...
  update: (id: string, data: Partial<{ title: string; description: string; labels: string; deadline: string; status: string; blockReason: string | null; assignedToUserId: string | null; reportSummary: string | null }>) =>
