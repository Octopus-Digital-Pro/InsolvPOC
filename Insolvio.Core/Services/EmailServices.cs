...
public sealed class CaseEmailService : ICaseEmailService
{
    ...
    public CaseEmailService(IApplicationDbContext db, ICurrentUserService currentUser, IAuditService audit)
    {
        _db = db;
...
public sealed class BulkEmailService : IBulkEmailService
{
    ...
    public BulkEmailService(IApplicationDbContext db, ICurrentUserService currentUser, IAuditService audit)
    {
        _db = db;
        _currentUser = currentUser;
        _audit = audit;
