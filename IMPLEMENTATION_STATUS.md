...
#### New Keys Added
- `nav.tenants`: "Tenants" / "Chiria?i" / "Bérl?k"
...
### 6. **TypeScript Linting Fixes**

#### Errors to Fix
- Remove unused imports: `XCircle`, `Check`, `Activity`
- Replace `any` types with proper interfaces
- Fix `unknown` ReactNode type assertions (cast to `string`)
- Remove unused variables: `isGlobalAdmin`, `_firm`

**Non-Blocking**: These are ESLint warnings, not compilation errors. App runs fine.
...
- **Controllers**: 22 (incl. TribunalsController, missing 2)
...
**Priority**: 
1. Migration (blocks everything)
2. Missing controllers (FinanceAuthorities, LocalGovernments)
3. Frontend authority tabs
4. Demo reset
5. CSV/ZIP exports
6. TypeScript linting cleanup
