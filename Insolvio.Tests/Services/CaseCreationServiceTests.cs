...
public class CaseCreationServiceTests
{
  ...
  private static (CaseCreationService svc, Insolvio.Data.ApplicationDbContext db) CreateService()
  {
    ...
    currentUser.Setup(u => u.Email).Returns("test@insolvio.local");
...
e.Subject.Should().Contain("Insolvio");
});
  }
