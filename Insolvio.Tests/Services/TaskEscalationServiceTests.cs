...
using Insolvio.Tests.Helpers;
using TaskStatus = Insolvio.Domain.Enums.TaskStatus;

namespace Insolvio.Tests.Services;

public class TaskEscalationServiceTests
{
  private static readonly Guid TenantId = Guid.NewGuid();

  private static (TaskEscalationService svc, Insolvio.Data.ApplicationDbContext db) CreateService()
  {
  ...
  private static void SeedUsers(Insolvio.Data.ApplicationDbContext db, out Guid practitionerId, out Guid adminId, out Guid partnerId)
  {
