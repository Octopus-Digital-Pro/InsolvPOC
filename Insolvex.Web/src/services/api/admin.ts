...
export const tenantsApi = {
  ...
  create: (data: { name: string; domain?: string; planName?: string }) => client.post<TenantDto>("/tenants", data),
  update: (id: string, data: Partial<TenantDto>) => client.put<TenantDto>(`/tenants/${id}`, data),
};
